                ...
                : (function e(t, n) {
                    ...
                    if (t) {
                      ...
                      for (
                        ...
                        if (void 0 === r[o[a]]) {
                          for (
                            var s = 2, u = o.slice(a, a + s).join(i), l = r[u];
                            void 0 === l && o.length > a + s;

                          )
                            s++, (l = r[(u = o.slice(a, a + s).join(i))]);
                          if (void 0 === l) return;
            ...
            },
            {
              ...
              value: function (t, i, r) {
                ...
                if (
                  ...
                  if (!i.returnObjects && !this.options.returnObjects)
                    return (
                      ...
                      this.options.returnedObjectHandler
                        ? this.options.returnedObjectHandler(y, v, i)
                        : "key '"
                            .concat(l, ' (')
                            .concat(
                              this.language,
                  ...
                  var R = !1,
                    C = !1,
                    j = void 0 !== i.count && 'string' != typeof i.count,
                    E = o.hasDefaultValue(i),
                    P = j ? this.pluralResolver.getSuffix(g, i.count) : '',
                    F = i['defaultValue'.concat(P)] || i.defaultValue;
                  !this.isValidLookup(v) && E && ((R = !0), (v = F)),
                    this.isValidLookup(v) || ((C = !0), (v = l));
                  var V = E && F !== v && this.options.updateMissing;
                  if (C || R || V) {
                    if (
                      (this.logger.log(
                      ...
                      var T = this.resolve(l, n({}, i, { keySeparator: !1 }));
                      T &&
                        T.res &&
                        this.logger.warn(
                    ...
                    if ('fallback' === this.options.saveMissingTo && U && U[0])
                      for (var D = 0; D < U.length; D++) A.push(U[D]);
                    else
                    ...
                    var I = function (e, t, n) {
                      a.options.missingKeyHandler
                        ? a.options.missingKeyHandler(e, p, t, V ? n : v, V, i)
                        : a.backendConnector &&
                      ...
                      (this.options.saveMissingPlurals && j
                        ? A.forEach(function (e) {
                            a.pluralResolver
                              .getSuffixes(e)
                              .forEach(function (t) {
                                I([e], l + t, i['defaultValue'.concat(t)] || F);
                              });
                          })
                        : I(A, l, F));
                  }
                  ...
                  e.forEach(function (e) {
                    if (!a.isValidLookup(t)) {
                      ...
                      c.forEach(function (e) {
                        a.isValidLookup(t) ||
                          ((r = e),
                          !N[''.concat(f[0], '-').concat(e)] &&
                            a.utils &&
                            a.utils.hasLoadedNamespace &&
                            !a.utils.hasLoadedNamespace(r) &&
                            ((N[''.concat(f[0], '-').concat(e)] = !0),
                            a.logger.warn(
                              'key "'
