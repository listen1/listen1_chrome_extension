export default {
  ...
  _CONFIRM_NOTICE_LASTFM:
    'Cliquez sur "Oui, tout autoriser" dans la nouvelle page, autoriser l\'accès à votre compte.',
  ...
  _CONFIRM_NOTICE_GITHUB:
    "Cliquez sur  \"S'identifier\" dans la nouvelle page, autoriser l'accès à votre compte.",
  ...
  _BACKUP_WARNING:
    "Réinstallez ou effacez votre cache vous fera perdre toutes vos playlists, les sauvegardes sont recommandés.",
  ...
  _RECOVER_WARNING:
    "Séléctionner un fichier de sauvegarde. Notice: Elle remplacera la playliste actuelle.",
  ...
  _SHOW_DESKTOP_LYRIC_TRANSLATION:
    "Afficher les traductions de paroles du bureau",
  ...
  _REMOVE_SONG_FROM_PLAYLIST_SUCCESS:
    "Succès: Retirer la morceau de la Playlist",
  ...
  _AUTO_CHOOSE_SOURCE_NOTICE:
    "If play fail, auto choose source from other music platform.",
  ...
  _LISTEN1_LOGIN_NOTICE:
    "Listen1 NE transférera PAS les données de votre compte vers un serveur autre que le serveur de la plate-forme musicale.",
  _PASSWORD: "Password",
  _LOGIN: "Login",
  _LOGOUT: "Logout",
  ...
  _LOGIN_DIALOG_NOTICE:
    "Opening Login page, please login in that page and click finish login",
