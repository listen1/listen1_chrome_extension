export default {
  ...
  _CONFIRM_NOTICE_LASTFM:
    'Please click "Yes, all access" in new page, allow Listen 1 access your account.',
  ...
  _CONFIRM_NOTICE_GITHUB:
    'Please click "Authencate" in new page, allow Listen 1 access your account',
  ...
  _BACKUP_WARNING:
    "Reinstall or clear cache will lost all your playlists, backup is STORNG RECOMMENDED.",
  ...
  _RECOVER_WARNING:
    "Choose Backup File. Notice: It will overwrite current playlists.",
  ...
  _COPYRIGHT_ISSUE:
    "Fail because copyright issue, Search other platform instead",
  ...
  _AUTO_CHOOSE_SOURCE_NOTICE:
    "Enable choose source from other music platform after fail.",
  ...
  _LISTEN1_LOGIN_NOTICE:
    "Listen1 WILL NOT transfer your account data to any server other than music platform server.",
  _PASSWORD: "Password",
  _LOGIN: "Login",
  _LOGOUT: "Logout",
