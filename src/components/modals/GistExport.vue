<template>
  <DefaultModal>
    ...
    <template #body>
      <ul class="text-left">
        <li class="cursor-pointer h-24 p-2 hover:bg-dialog-hover" @click="download()">
        ...
        <li v-for="(backup, index) in myBackup" :key="index" class="cursor-pointer h-24 p-2 hover:bg-dialog-hover" @click="backup(backup.id, backup.public)">
          <img class="float-left h-20 w-20 mr-4" src="../../images/mycover.jpg" />
