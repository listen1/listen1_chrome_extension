<template>
  <div v-if="isWin() || isLinux()" class="border-l border-default">
    <div class="inline-block w-6 h-6 ml-4 overflow-hidden" @click="sendControl('window_min')">
      <vue-feather size="1.25rem" class="icon opacity-50 hover:opacity-100 -mb-3" type="minus" />
    </div>
